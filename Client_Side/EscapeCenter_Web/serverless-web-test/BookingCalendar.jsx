...
const BookingCalendar = () => {
    const [isConnected] = useState(true); // No backend needed
    ...
    // Mock data: Some pre-filled bookings
    useEffect(() => {
        // Simulate some existing bookings
        const mockBookings = {
            "07.02/10:00-11:30/אחוזת השכן": { firstName: "דני", lastName: "כהן" },
            "07.02/14:00-15:30/מקדש הקאמי": { firstName: "שרה", lastName: "לוי" },
            "08.02/12:00-13:30/אינפיניטי": { firstName: "יוסי", lastName: "מזרחי" },
            "09.02/16:00-17:30/נרקוס": { firstName: "מיכל", lastName: "אברהם" },
        };
    ...
    const handleSubmit = () => {
        ...
        alert("הזמנה נשמרה בהצלחה! (מצב הדגמה - ללא שרת)");
    ...
    return (
        <div className="calendar-container">
            <div className="demo-banner">
                🧪 מצב הדגמה - Serverless Test Mode (ללא שרת)
            </div>
